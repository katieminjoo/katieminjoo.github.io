...
마지막으로 실제로 어떤 분포로부터 샘플을 만들어내는 일이 필요한 경우가 굉장히 많습니다. 대표적으로 single image super-resolution/ 

다른 여러 정답들과 연결되어 있을 수 있습니다. 

할 때 사용되는데, 이러한 점들이 강화학습에 큰 도움이 된다고 합니다. 
...
![](/assets/img/post/[DL]GAN/[1]code.PNG)
...
![](/assets/img/post/[DL]GAN/[4]proposition3.PNG)
